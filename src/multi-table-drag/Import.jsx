...
newer()
 ...
 let header = []
   entities.columns.done.taskIds.map((column,index) => {
  return header.push( { label: column, key: column })
 ...
 console.log("d",header)
  ...
  const handleInputChange = (index, event) => {
    const values = [...entities.columns.done.taskIds];
